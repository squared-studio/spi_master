...
package spi_master_pkg;
  ...
  typedef logic [NUM_WIRES-1:0] spi_bus_logic_t;
  typedef wire  [NUM_WIRES-1:0] spi_bus_wire_t;
  ...
  parameter spi_bus_logic_t NO_DRIVE     = 'b0000;  // No drive on any wire (high impedance)
  parameter spi_bus_logic_t SINGLE_DRIVE = 'b0001;  // No drive on any wire (high impedance)
  parameter spi_bus_logic_t DUAL_DRIVE   = 'b0011;  // No drive on any wire (high impedance)
  parameter spi_bus_logic_t QUAD_DRIVE   = 'b1111;  // No drive on any wire (high impedance)
